...
const addressSchema = joi_1.default.object({
    street: joi_1.default.string().required().messages({ 'any.required': 'Street is required' }),
    city: joi_1.default.string().required().messages({ 'any.required': 'City is required' }),
...
const userValidateSchema = joi_1.default.object({
    userId: joi_1.default.number().required().messages({ 'any.required': 'User ID is required' }),
    ...
    isActive: joi_1.default.boolean().required().messages({ 'any.required': 'Active status is required' }),
